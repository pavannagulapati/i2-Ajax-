    ...
    function specify() {
      ...
      $(window).resize(function () {
        $("[cell-c]").each(function () {
          ...
          if (ele == 'c') {
            var colSize = col[1] * 5
            $(this).css({ 'width': '' + colSize + '%', 'flexGrow': '0' });
          }
          if (eleCo == 'co') {
            $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
          }
          if (eleCa == 'ca') {
            $(this).css({ 'width': 'max-content', 'flexGrow': '0' });
          }
          if (ele != 'c') {
            if (eleD == 'd') {
              var colSizeDesk = colDesk[1] * 5
              $(this).css({ 'width': '' + colSizeDesk + '%', 'flexGrow': '0' });
            }
            if (eleCoD == 'do') {
              $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
            }
            ...
            if (eleL == 'l' & eleD != 'd') {
              ...
              $(this).css({ 'width': '' + colSizeLarge + '%', 'flexGrow': '0' });
            }
            if (eleCoL == 'lo') {
              $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
            }
            ...
            if (eleT == 't' & eleD != 'd' & eleL != 'l') {
              ...
              $(this).css({ 'width': '' + colSizeTab + '%', 'flexGrow': '0' });
            }
            if (eleCoT == 'to') {
              $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
            }
            ...
            if (eleM == 'm' & eleD != 'd' & eleL != 'l' & eleT != 't') {
              ...
              $(this).css({ 'width': '' + colSizeMobile + '%', 'flexGrow': '0' });
            }
            if (eleCoM == 'mo') {
              $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
            }
            ...
            if (eleS == 's' & eleD != 'd' & eleL != 'l' & eleT != 't' & eleM != 'm') {
              ...
              $(this).css({ 'width': '' + colSizeSmall + '%', 'flexGrow': '0' });
            }
            if (eleCoS == 'so') {
              $(this).css({ 'width': 'min-content', 'flexGrow': '1' });
            }
    ...
    function specify() {
      ...
      $(window).resize(function () {
        ...
        $("[cell-Q]").each(function () {
          ...
          if (ele == 'gh') {
            $(this).find('[cell-c]').css({ 'marginLeft': '' + margin[1] + 'px', 'marginRight': '' + margin[2] + 'px' });
          }
          if (ele != 'gh') {
            if (eleD == 'dh') {
              $(this).css({ 'marginLeft': '' + marginDesk[1] + 'px', 'marginRight': '' + marginDesk[2] + 'px' });
            }
            if (eleL == 'lh' & eleD != 'dh') {
              $(this).find('[cell-c]').css({ 'marginLeft': '' + marginLarge[1] + 'px', 'marginRight': '' + marginLarge[2] + 'px' });
            }
            if (eleT == 'th' & eleD != 'dh' & eleL != 'lh') {
              $(this).find('[cell-c]').css({ 'marginLeft': '' + marginTab[1] + 'px', 'marginRight': '' + marginTab[2] + 'px' });
            }
            if (eleM == 'mh' & eleD != 'dh' & eleL != 'lh' & eleT != 'th') {
              $(this).find('[cell-c]').css({ 'marginLeft': '' + marginMobile[1] + 'px', 'marginRight': '' + marginMobile[2] + 'px' });
            }
            if (eleS == 'sh' & eleD != 'dh' & eleL != 'lh' & eleT != 'th' & eleM != 'mh') {
              $(this).find('[cell-c]').css({ 'marginLeft': '' + marginSmall[1] + 'px', 'marginRight': '' + marginSmall[2] + 'px' });
            }
          }
          ...
          if (width >= 1484.99 && width <= 2500) {
            if (eleD == 'dh') {
              $(this).find('[cell-c]').css({ 'marginLeft': '' + marginDesk[1] + 'px', 'marginRight': '' + marginDesk[2] + 'px' });
            }
          }
          if (width >= 1199.99 && width <= 1484.98) {
            if (eleD == 'dh') {
        ...
        $("[cell-Q]").each(function () {
          ...
          if (ele == 'gv') {
            $(this).find('[cell-c]').css({ 'marginTop': '' + margin[1] + 'px', 'marginBottom': '' + margin[2] + 'px' });
          }
          if (ele != 'gv') {
            if (eleD == 'dv') {
              $(this).find('[cell-c]').css({ 'marginTop': '' + marginDesk[1] + 'px', 'marginBottom': '' + marginDesk[2] + 'px' });
            }
            if (eleL == 'lv' & eleD != 'dv') {
              $(this).find('[cell-c]').css({ 'marginTop': '' + marginLarge[1] + 'px', 'marginBottom': '' + marginLarge[2] + 'px' });
            }
            if (eleT == 'tv' & eleD != 'dv' & eleL != 'lv') {
              $(this).find('[cell-c]').css({ 'marginTop': '' + marginTab[1] + 'px', 'marginBottom': '' + marginTab[2] + 'px' });
            }
            if (eleM == 'mv' & eleD != 'dv' & eleL != 'lv' & eleT != 'tv') {
              $(this).find('[cell-c]').css({ 'marginTop': '' + marginMobile[1] + 'px', 'marginBottom': '' + marginMobile[2] + 'px' });
            }
            if (eleS == 'sv' & eleD != 'dv' & eleL != 'lv' & eleT != 'tv' & eleM != 'mv') {
              $(this).find('[cell-c]').css({ 'marginTop': '' + marginSmall[1] + 'px', 'marginBottom': '' + marginSmall[2] + 'px' });
            }
          }
    ...
    function specify() {
      ...
      $(window).resize(function () {
        $("[cell-G]").each(function () {
          ...
          if (ele[0] == 'gc1') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto' });
          }
          if (ele[0] == 'gc2') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto' });
          }
          if (ele[0] == 'gc3') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto' });
          }
          if (ele[0] == 'gc4') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto' });
          }
          if (ele[0] == 'gc5') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto' });
          }
          if (ele[0] == 'gc6') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc7') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc8') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc9') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc10') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc11') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc12') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc13') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc14') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc15') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc16') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc17') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc18') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc19') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
          if (ele[0] == 'gc20') {
            $(this).css({ 'display': 'grid', 'gridTemplateColumns': 'auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto' });
          }
        })
      })
        .resize();
    ...
    function specify() {
      ...
      $(window).resize(function () {
        $("[cell-Gb]").each(function () {
          ...
          if (ele == 'b') {
            $(this).css({ 'gridColumn': '' + box[1] + '/span ' + box[2] + '' });
          }
          if (ele != 'b') {
            if (eleD == 'db') {
              $(this).css({ 'gridColumn': '' + boxDesk[1] + '/span ' + boxDesk[2] + '' });
            }
            if (eleL == 'lb' & eleD != 'db') {
              $(this).css({ 'gridColumn': '' + boxLarge[1] + '/span ' + boxLarge[2] + '' });
            }
            if (eleT == 'tb' & eleD != 'db' & eleL != 'lb') {
              $(this).css({ 'gridColumn': '' + boxTab[1] + '/span ' + boxTab[2] + '' });
            }
            if (eleM == 'mb' & eleD != 'db' & eleL != 'lb' & eleT != 'tb') {
              $(this).css({ 'gridColumn': '' + boxMobile[1] + '/span ' + boxMobile[2] + '' });
            }
            if (eleS == 'sb' & eleD != 'db' & eleL != 'lb' & eleT != 'tb' & eleM != 'mb') {
              $(this).css({ 'gridColumn': '' + boxSmall[1] + '/span ' + boxSmall[2] + '' });
            }
          }
        ...
        $("[cell-Gb]").each(function () {
          ...
          if (ele == 'gh') {
            $(this).css({ 'marginLeft': '' + margin[1] + 'px', 'marginRight': '' + margin[2] + 'px' });
          }
          if (ele != 'gh') {
            if (eleD == 'dh') {
              $(this).css({ 'marginLeft': '' + marginDesk[1] + 'px', 'marginRight': '' + marginDesk[2] + 'px' });
            ...
            if (eleL == 'lh' & eleD != 'dh') {
              $(this).css({ 'marginLeft': '' + marginLarge[1] + 'px', 'marginRight': '' + marginLarge[2] + 'px' });
            }
            if (eleT == 'th' & eleD != 'dh' & eleL != 'lh') {
              $(this).css({ 'marginLeft': '' + marginTab[1] + 'px', 'marginRight': '' + marginTab[2] + 'px' });
            }
            if (eleM == 'mh' & eleD != 'dh' & eleL != 'lh' & eleT != 'th') {
              $(this).css({ 'marginLeft': '' + marginMobile[1] + 'px', 'marginRight': '' + marginMobile[2] + 'px' });
            }
            if (eleS == 'sh' & eleD != 'dh' & eleL != 'lh' & eleT != 'th' & eleM != 'mh') {
              $(this).css({ 'marginLeft': '' + marginSmall[1] + 'px', 'marginRight': '' + marginSmall[2] + 'px' });
            }
          }
        ...
        $("[cell-Gb]").each(function () {
          ...
          if (ele == 'gv') {
            $(this).css({ 'marginTop': '' + margin[1] + 'px', 'marginBottom': '' + margin[2] + 'px' });
          }
          if (ele != 'gv') {
            if (eleD == 'dv') {
              $(this).css({ 'marginTop': '' + marginDesk[1] + 'px', 'marginBottom': '' + marginDesk[2] + 'px' });
            }
            if (eleL == 'lv' & eleD != 'dv') {
              $(this).css({ 'marginTop': '' + marginLarge[1] + 'px', 'marginBottom': '' + marginLarge[2] + 'px' });
            }
            if (eleT == 'tv' & eleD != 'dv' & eleL != 'lv') {
              $(this).css({ 'marginTop': '' + marginTab[1] + 'px', 'marginBottom': '' + marginTab[2] + 'px' });
            }
            if (eleM == 'mv' & eleD != 'dv' & eleL != 'lv' & eleT != 'tv') {
              $(this).css({ 'marginTop': '' + marginMobile[1] + 'px', 'marginBottom': '' + marginMobile[2] + 'px' });
            }
            if (eleS == 'sv' & eleD != 'dv' & eleL != 'lv' & eleT != 'tv' & eleM != 'mv') {
              $(this).css({ 'marginTop': '' + marginSmall[1] + 'px', 'marginBottom': '' + marginSmall[2] + 'px' });
            }
          }
    ...
    function specify() {
      ...
      $(window).resize(function () {
        $("[cell-t]").each(function () {
          ...
          if (elePs == 'ps') {
            $(this).css({ 'textIndent': '' + paraSpace[1] + '%' });
          }
          if (ele == 's') {
            $(this).css({ 'letterSpacing': '' + space[1] + 'px', 'wordSpacing': '' + space[2] + 'px' });
          }
          if (ele != 's') {
            if (eleD == 'ds') {
              $(this).css({ 'letterSpacing': '' + spaceDesk[1] + 'px', 'wordSpacing': '' + spaceDesk[2] + 'px' });
            }
            if (eleL == 'ls' & eleD != 'ds') {
              $(this).css({ 'letterSpacing': '' + spaceLarge[1] + 'px', 'wordSpacing': '' + spaceLarge[2] + 'px' });
            }
            if (eleT == 'ts' & eleD != 'ds' & eleL != 'ls') {
              $(this).css({ 'letterSpacing': '' + spaceTab[1] + 'px', 'wordSpacing': '' + spaceTab[2] + 'px' });
            }
            if (eleM == 'ms' & eleD != 'ds' & eleL != 'ls' & eleT != 'ts') {
              $(this).css({ 'letterSpacing': '' + spaceMobile[1] + 'px', 'wordSpacing': '' + spaceMobile[2] + 'px' });
            }
            if (eleS == 'ss' & eleD != 'ds' & eleL != 'ls' & eleT != 'ts' & eleM != 'ms') {
              $(this).css({ 'letterSpacing': '' + spaceSmall[1] + 'px', 'wordSpacing': '' + spaceSmall[2] + 'px' });
            }
          }
      ...
      $(window).resize(function () {
        ...
        $("[cell-ts]").each(function () {
          ...
          if (ele == 'l') {
            ...
            $(this).css({ 'textShadow': '-' + shadow[1] + 'px 0px 5px ' + colors[shadowNum] + '' });
          }
          if (ele != 'l') {
            if (eleD == 'dl') {
              var shadowDeskNum = shadowDesk[2] - 1
              $(this).css({ 'textShadow': '-' + shadowDesk[1] + 'px 0px 5px ' + colors[shadowDeskNum] + '' });
            }
            if (eleL == 'll' & eleD != 'dl') {
              var shadowLargeNum = shadowLarge[2] - 1
              $(this).css({ 'textShadow': '-' + shadowLarge[1] + 'px 0px 5px ' + colors[shadowLargeNum] + '' });
            }
            if (eleT == 'tl' & eleD != 'dl' & eleL != 'll') {
              var shadowTabNum = shadowTab[2] - 1
              $(this).css({ 'textShadow': '-' + shadowTab[1] + 'px 0px 5px ' + colors[shadowTabNum] + '' });
            }
            if (eleM == 'ml' & eleD != 'dl' & eleL != 'll' & eleT != 'tl') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'textShadow': '-' + shadowDesk[1] + 'px 0px 5px ' + colors[shadowMobileNum] + '' });
            }
            if (eleS == 'sl' & eleD != 'dl' & eleL != 'll' & eleT != 'tl' & eleM != 'ml') {
              var shadowSmallNum = shadowSmall[2] - 1
              $(this).css({ 'textShadow': '-' + shadowSmall[1] + 'px 0px 5px ' + colors[shadowSmallNum] + '' });
            }
          }
          ...
          if (width >= 575.99 && width <= 767.98) {
            if (eleM == 'ml') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'textShadow': '-' + shadowMobile[1] + 'px 0px 5px ' + colors[shadowMobileNum] + '' });
            }
          }
          if (width >= 319.98 && width <= 575.98) {
            if (eleS == 'sl') {
        ...
        $("[cell-ts]").each(function () {
          ...
          if (ele == 't') {
            var shadowNum = shadow[2] - 1
            $(this).css({ 'textShadow': '0px -' + shadow[1] + 'px 5px ' + colors[shadowNum] + '' });
          }
          if (ele != 't') {
            if (eleD == 'dt') {
              var shadowDeskNum = shadowDesk[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowDesk[1] + 'px 5px ' + colors[shadowDeskNum] + '' });
            }
            if (eleL == 'lt' & eleD != 'dt') {
              var shadowLargeNum = shadowLarge[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowLarge[1] + 'px 5px ' + colors[shadowLargeNum] + '' });
            }
            if (eleT == 'tt' & eleD != 'dt' & eleL != 'lt') {
              var shadowTabNum = shadowTab[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowTab[1] + 'px 5px ' + colors[shadowTabNum] + '' });
            }
            if (eleM == 'mt' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowDesk[1] + 'px 5px ' + colors[shadowMobileNum] + '' });
            }
            if (eleS == 'st' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt' & eleM != 'mt') {
              var shadowSmallNum = shadowSmall[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowSmall[1] + 'px 5px ' + colors[shadowSmallNum] + '' });
            }
          }
          ...
          if (width >= 575.99 && width <= 767.98) {
            if (eleM == 'mt') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'textShadow': '0px -' + shadowMobile[1] + 'px 5px ' + colors[shadowMobileNum] + '' });
            }
          }
          if (width >= 319.98 && width <= 575.98) {
            if (eleS == 'st') {
      ...
      $(window).resize(function () {
        $("[cell-bs]").each(function () {
          ...
          if (eleTl == 'w') {
            var shadowTopLeftNum = shadowTopLeft[2] - 1
            var neg = shadowTopLeft[1] * (-1)
            $(this).css({ 'boxShadow': '' + neg + 'px ' + neg + 'px 15px 0px ' + colors[shadowTopLeftNum] + '' });
          }
          if (eleTr == 'x') {
            var shadowTopRightNum = shadowTopRight[2] - 1
            var neg = shadowTopRight[1] * (-1)
            var pos = shadowTopRight[1] * (1)
            $(this).css({ 'boxShadow': '' + pos + 'px ' + neg + 'px 15px 0px ' + colors[shadowTopRightNum] + '' });
          }
          if (eleBl == 'y') {
            var shadowBottomLeftNum = shadowBottomLeft[2] - 1
            var neg = shadowBottomLeft[1] * (-1)
            var pos = shadowBottomLeft[1] * (1)
            $(this).css({ 'boxShadow': '' + neg + 'px ' + pos + 'px 15px 0px ' + colors[shadowBottomLeftNum] + '' });
          }
          if (eleBr == 'z') {
            var shadowBottomRightNum = shadowBottomRight[2] - 1
            var neg = shadowBottomRight[1] * (-1)
            var pos = shadowBottomRight[1] * (1)
            $(this).css({ 'boxShadow': '' + pos + 'px ' + pos + 'px 15px 0px ' + colors[shadowBottomRightNum] + '' });
          }
        })
        $("[cell-bs]").each(function () {
          ...
          if (ele == 'l') {
            var shadowNum = shadow[2] - 1
            $(this).css({ 'boxShadow': '-' + shadow[1] + 'px 0px 15px 0px ' + colors[shadowNum] + '' });
          }
          if (ele != 'l') {
            if (eleD == 'dl') {
              var shadowDeskNum = shadowDesk[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowDesk[1] + 'px 0px 15px 0px ' + colors[shadowDeskNum] + '' });
            }
            if (eleL == 'll' & eleD != 'dl') {
              var shadowLargeNum = shadowLarge[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowLarge[1] + 'px 0px 15px 0px ' + colors[shadowLargeNum] + '' });
            }
            if (eleT == 'tl' & eleD != 'dl' & eleL != 'll') {
              var shadowTabNum = shadowTab[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowTab[1] + 'px 0px 15px 0px ' + colors[shadowTabNum] + '' });
            }
            if (eleM == 'ml' & eleD != 'dl' & eleL != 'll' & eleT != 'tl') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowDesk[1] + 'px 0px 15px 0px ' + colors[shadowMobileNum] + '' });
            }
            if (eleS == 'sl' & eleD != 'dl' & eleL != 'll' & eleT != 'tl' & eleM != 'ml') {
              var shadowSmallNum = shadowSmall[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowSmall[1] + 'px 0px 15px 0px ' + colors[shadowSmallNum] + '' });
            }
          }
          ...
          if (width >= 575.99 && width <= 767.98) {
            if (eleM == 'ml') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'boxShadow': '-' + shadowMobile[1] + 'px 0px 15px 0px ' + colors[shadowMobileNum] + '' });
            }
          }
          if (width >= 319.98 && width <= 575.98) {
            if (eleS == 'sl') {
        ...
        $("[cell-bs]").each(function () {
          ...
          if (ele == 't') {
            var shadowNum = shadow[2] - 1
            $(this).css({ 'boxShadow': '0px -' + shadow[1] + 'px 15px 0px ' + colors[shadowNum] + '' });
          }
          if (ele != 't') {
            if (eleD == 'dt') {
              var shadowDeskNum = shadowDesk[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowDesk[1] + 'px 15px 0px ' + colors[shadowDeskNum] + '' });
            }
            if (eleL == 'lt' & eleD != 'dt') {
              var shadowLargeNum = shadowLarge[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowLarge[1] + 'px 15px 0px ' + colors[shadowLargeNum] + '' });
            }
            if (eleT == 'tt' & eleD != 'dt' & eleL != 'lt') {
              var shadowTabNum = shadowTab[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowTab[1] + 'px 15px 0px ' + colors[shadowTabNum] + '' });
            }
            if (eleM == 'mt' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowDesk[1] + 'px 15px 0px ' + colors[shadowMobileNum] + '' });
            }
            if (eleS == 'st' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt' & eleM != 'mt') {
              var shadowSmallNum = shadowSmall[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowSmall[1] + 'px 15px 0px ' + colors[shadowSmallNum] + '' });
            }
          }
          ...
          if (width >= 575.99 && width <= 767.98) {
            if (eleM == 'mt') {
              var shadowMobileNum = shadowMobile[2] - 1
              $(this).css({ 'boxShadow': '0px -' + shadowMobile[1] + 'px 15px 0px ' + colors[shadowMobileNum] + '' });
            }
          }
          if (width >= 319.98 && width <= 575.98) {
            if (eleS == 'st') {
    ...
    function specify() {
      ...
      $(window).resize(function () {
        ...
        $("[cell-b]").each(function () {
          ...
          if (eleG == 'go') {
            $(this).css({ 'borderLeft': 'double ' + gradient[1] + 'px transparent' });
            $(this).css({ 'borderRight': 'double ' + gradient[1] + 'px transparent' });
            $(this).css({ 'borderBottom': 'double ' + gradient[1] + 'px transparent' });
            $(this).css({ 'borderTop': 'double ' + gradient[1] + 'px transparent' });
            if (eleGv == 'gv') {
              var gradientNum = gradient[2] - 1;
              var gradientFirstNum = gradientVertical[1] - 1;
              var gradientSecondNum = gradientVertical[2] - 1;
              $(this).css({ 'backgroundImage': 'linear-gradient(' + colors[gradientNum] + ', ' + colors[gradientNum] + '),linear-gradient(90deg, ' + colors[gradientFirstNum] + ', ' + colors[gradientSecondNum] + '' });
              $(this).css({ 'backgroundOrigin': 'border-box', 'backgroundClip': 'content-box,border-box' });
            }
            if (eleGh == 'gh') {
              var gradientNum = gradient[2] - 1;
              var gradientFirstNum = gradientHorizontal[1] - 1;
              var gradientSecondNum = gradientHorizontal[2] - 1;
              $(this).css({ 'backgroundImage': 'linear-gradient(' + colors[gradientNum] + ', ' + colors[gradientNum] + '),linear-gradient(180deg, ' + colors[gradientFirstNum] + ', ' + colors[gradientSecondNum] + '' });
              $(this).css({ 'backgroundOrigin': 'border-box', 'backgroundClip': 'content-box,border-box' });
            }
          }
          if (eleGl == 'gl') {
            $(this).css({ 'borderLeft': 'double ' + gradientLeft[1] + 'px transparent' });
          ...
          if (eleGr == 'gr') {
            $(this).css({ 'borderRight': 'double ' + gradientRight[1] + 'px transparent' });
          ...
          if (eleGt == 'gt') {
            $(this).css({ 'borderTop': 'double ' + gradientTop[1] + 'px transparent' });
            $(this).css({ 'borderRight': '0' });
            $(this).css({ 'borderBottom': '0' });
            $(this).css({ 'borderLeft': '0' });
            if (eleGv == 'gv') {
          ...
          if (eleGb == 'gb') {
            $(this).css({ 'borderBottom': 'double ' + gradientBottom[1] + 'px transparent' });
            $(this).css({ 'borderRight': '0' });
            $(this).css({ 'borderLeft': '0' });
            $(this).css({ 'borderTop': '0' });
            if (eleGv == 'gv') {
    ...
    function specify() {
      ...
      $(window).resize(function () {
        ...
        $("[cell-r]").each(function () {
          ...
          if (ele == 'rt') {
            $(this).css({ 'borderTopLeftRadius': '' + radiusTop[1] + 'px', 'borderTopRightRadius': '' + radiusTop[2] + 'px' });
          }
          if (ele != 'rt') {
            if (eleD == 'dt') {
              $(this).css({ 'borderTopLeftRadius': '' + radiusTopDesk[1] + 'px', 'borderTopRightRadius': '' + radiusTopDesk[2] + 'px' });
            }
            if (eleL == 'lt' & eleD != 'dt') {
              $(this).css({ 'borderTopLeftRadius': '' + radiusTopLarge[1] + 'px', 'borderTopRightRadius': '' + radiusTopLarge[2] + 'px' });
            }
            if (eleT == 'tt' & eleD != 'dt' & eleL != 'lt') {
              $(this).css({ 'borderTopLeftRadius': '' + radiusTopTab[1] + 'px', 'borderTopRightRadius': '' + radiusTopTab[2] + 'px' });
            }
            if (eleM == 'mt' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt') {
              $(this).css({ 'borderTopLeftRadius': '' + radiusTopMobile[1] + 'px', 'borderTopRightRadius': '' + radiusTopMobile[2] + 'px' });
            }
            if (eleS == 'st' & eleD != 'dt' & eleL != 'lt' & eleT != 'tt' & eleM != 'mt') {
              $(this).css({ 'borderTopLeftRadius': '' + radiusTopSmall[1] + 'px', 'borderTopRightRadius': '' + radiusTopSmall[2] + 'px' });
            }
          }
        ...
        $("[cell-r]").each(function () {
          ...
          if (ele == 'rb') {
            $(this).css({ 'borderBottomLeftRadius': '' + radiusBottom[1] + 'px', 'borderBottomRightRadius': '' + radiusBottom[2] + 'px' });
          }
          if (ele != 'rb') {
            if (eleD == 'db') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomDesk[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomDesk[2] + 'px' });
            }
            if (eleL == 'lb' & eleD != 'db') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomLarge[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomLarge[2] + 'px' });
            }
            if (eleT == 'tb' & eleD != 'db' & eleL != 'lb') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomTab[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomTab[2] + 'px' });
            }
            if (eleM == 'mb' & eleD != 'db' & eleL != 'lb' & eleT != 'tb') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomMobile[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomMobile[2] + 'px' });
            }
            if (eleS == 'sb' & eleD != 'db' & eleL != 'lb' & eleT != 'tb' & eleM != 'mb') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomSmall[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomSmall[2] + 'px' });
            }
          }
          ...
          if (width >= 319.98 && width <= 575.98) {
            if (eleS == 'sb') {
              $(this).css({ 'borderBottomLeftRadius': '' + radiusBottomSmall[1] + 'px', 'borderBottomRightRadius': '' + radiusBottomDeskSmall[2] + 'px' });
            }
          }
          else if (width < 319.98) {
            if (eleS == 'sb') {
    ...
    function specify() {
      ...
      $(window).resize(function () {
        $(".input-box").each(function () {
          ...
          if (eleBl == 'bl') {
            var borderLeftNum = borderLeft[2] - 1;
            $(this).find('input').css({ 'botderTop': '0', 'botderRight': '0', 'botderBottom': '0' })
          ...
          if (eleBr == 'br') {
            var borderRightNum = borderRight[2] - 1;
            $(this).find('input').css({ 'botderTop': '0', 'botderBottom': '0', 'botderLeft': '0' })
          ...
          if (eleBt == 'bt') {
            var borderTopNum = borderTop[2] - 1;
            $(this).find('input').css({ 'botderBottom': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleBb == 'bb') {
            var borderBottomNum = borderBottom[2] - 1;
            $(this).find('input').css({ 'botderTop': '0', 'botderRight': '0', 'botderLeft': '0' })
        ...
        $(".icon-box").each(function () {
          ...
          if (eleIs == 'is') {
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-li"]').css({ 'fontSize': '' + iconSize[1] + 'px' });
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-ri"]').css({ 'fontSize': '' + iconSize[2] + 'px' });
          }
          ...
          if (eleIpl == 'pl') {
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-li"]').css({ 'paddingLeft': '' + iconPaddingLeft[1] + 'px' });
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-ri"]').css({ 'paddingLeft': '' + iconPaddingLeft[2] + 'px' });
          }

          if (eleIpr == 'pr') {
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-li"]').css({ 'paddingRight': '' + iconPaddingRight[1] + 'px' });
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-ri"]').css({ 'paddingRight': '' + iconPaddingRight[2] + 'px' });
          }

          if (eleIpt == 'pt') {
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-li"]').css({ 'paddingTop': '' + iconPaddingTop[1] + 'px' });
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-ri"]').css({ 'paddingTop': '' + iconPaddingTop[2] + 'px' });
          }

          if (eleIpb == 'pb') {
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-li"]').css({ 'paddingBottom': '' + iconPaddingBottom[1] + 'px' });
            $(this).find('div[cell-in^="["][cell-in$="]"][cell-in*="-ri"]').css({ 'paddingBottom': '' + iconPaddingBottom[2] + 'px' });
          }
          ...
          if (eleBl == 'bl') {
            var borderLeftNum = borderLeft[2] - 1;
            $(this).css({ 'botderTop': '0', 'botderRight': '0', 'botderBottom': '0' })
          ...
          if (eleBr == 'br') {
            var borderRightNum = borderRight[2] - 1;
            $(this).css({ 'botderTop': '0', 'botderBottom': '0', 'botderLeft': '0' })
          ...
          if (eleBt == 'bt') {
            var borderTopNum = borderTop[2] - 1;
            $(this).css({ 'botderBottom': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleBb == 'bb') {
            var borderBottomNum = borderBottom[2] - 1;
            $(this).css({ 'botderTop': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleTx == 'ts') {
            var textNum = text[2] - 1;
            $(this).parent('div[cell-in^="["][cell-in$="]"][cell-in*="-ic"]').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
          }
          if (eleTxHo == '.ts') {
            $(this).hover(function () {
              var textHoverNum = textHover[2] - 1;
              $(this).css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textHoverNum] + '' });
            })
            $(this).mouseleave(function () {
              var textNum = text[2] - 1;
              $(this).css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
            })
          }
        ...
        $(".select-area").each(function () {
          ...
          if (eleBl == 'bl') {
            var borderLeftNum = borderLeft[2] - 1;
            $(this).find('[cell-in^="["][cell-in$="]"][cell-in*="-bs"]').css({ 'botderTop': '0', 'botderRight': '0', 'botderBottom': '0' })
          ...
          if (eleBr == 'br') {
            var borderRightNum = borderRight[2] - 1;
            $(this).find('[cell-in^="["][cell-in$="]"][cell-in*="-bs"]').css({ 'botderTop': '0', 'botderBottom': '0', 'botderLeft': '0' })
          ...
          if (eleBt == 'bt') {
            var borderTopNum = borderTop[2] - 1;
            $(this).find('[cell-in^="["][cell-in$="]"][cell-in*="-bs"]').css({ 'botderBottom': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleBb == 'bb') {
            var borderBottomNum = borderBottom[2] - 1;
            $(this).find('[cell-in^="["][cell-in$="]"][cell-in*="-bs"]').css({ 'botderTop': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleTx == 'ts') {
            var textNum = text[2] - 1;
            $(this).css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
            $(this).find('option').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
          }
          if (eleTxHo == '.ts') {
            $(this).hover(function () {
              var textHoverNum = textHover[2] - 1;
        ...
        $(".select-area .box").each(function () {
          ...
          if (eleIpl == 'pl') {
            $(this).css({ 'paddingLeft': '' + iconPaddingLeft[1] + 'px' });
          }

          if (eleIpr == 'pr') {
            $(this).css({ 'paddingRight': '' + iconPaddingRight[1] + 'px' });
          }

          if (eleIpt == 'pt') {
            $(this).css({ 'paddingTop': '' + iconPaddingTop[1] + 'px' });
          }

          if (eleIpb == 'pb') {
            $(this).css({ 'paddingBottom': '' + iconPaddingBottom[1] + 'px' });
          }
          ...
          if (eleBl == 'bl') {
            var borderLeftNum = borderLeft[2] - 1;
            $(this).find('option').css({ 'botderTop': '0', 'botderRight': '0', 'botderBottom': '0' })
          ...
          if (eleBr == 'br') {
            var borderRightNum = borderRight[2] - 1;
            $(this).find('option').css({ 'botderTop': '0', 'botderBottom': '0', 'botderLeft': '0' })
          ...
          if (eleBt == 'bt') {
            var borderTopNum = borderTop[2] - 1;
            $(this).find('option').css({ 'botderBottom': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleBb == 'bb') {
            var borderBottomNum = borderBottom[2] - 1;
            $(this).find('option').css({ 'botderTop': '0', 'botderRight': '0', 'botderLeft': '0' })
          ...
          if (eleTxHo == '.ts') {
            $(this).hover(function () {
              var textHoverNum = textHover[2] - 1;
              $(this).find('option').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textHoverNum] + '' });
            })
            $(this).mouseleave(function () {
              var textNum = text[2] - 1;
              $(this).find('option').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
        ...
        $(".select-area .select-box").each(function () {
          ...
          if (eleTx == 'ts') {
            var textNum = text[2] - 1;
            $(this).find('select').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
          }
          if (eleTxHo == '.ts') {
            $(this).hover(function () {
              var textHoverNum = textHover[2] - 1;
              $(this).find('select').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textHoverNum] + '' });
            })
            $(this).mouseleave(function () {
              var textNum = text[2] - 1;
              $(this).find('select').css({ 'fontSize': '' + text[1] + 'px', 'color': '' + colors[textNum] + '' });
